...
dataframe.sort_values(["scores"], axis=0, ascending=False, inplace=True)
...
print('Accuracy for predictions using all features :',score_all_features)
print('Accuracy for predictions using top features :',score_top_features)
